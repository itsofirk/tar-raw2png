    ...
    def convert_tar(self, input_tar_path, resolution, image_list=None, output_tar_path=None, bufsize=16 * 1024,
        ...
        with (tarfile.open(input_tar_path, 'r', bufsize=bufsize) as input_tar,
            ...
            with ThreadPoolExecutor() as executor:
                futures = (executor.submit(_process_image, member) for member in members_to_convert)

                for future in concurrent.futures.as_completed(futures):
                    metadata, png_buffer = future.result()
...
if __name__ == '__main__':
    ...
    png_converter.convert_tar(tar_path, resolution_1280_720, bufsize=16 * 1024, image_list=None,
                              output_tar_path=output_path, batch_size=50)
